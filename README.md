...
[![GitHub Stats](https://github-stats-extended.vercel.app/api?username=AlexandreCoussediere&include_all_commits=true&theme=vue)](https://github-stats-extended.vercel.app/api?username=AlexandreCoussediere&include_all_commits=true&theme=vue)
...
| **Category** | **Skills** |
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| **Programming** | Python/HTML/CSS/JavaScript with React and SQL basics|
| **Languages** | Native French / English (level B1+, Evalang certified) / B1 Spanish and A1 Portuguese|
| **Digital skills** | Pix (480/895 points) – Validation of skills in security, content creation, and digital problem-solving. |
| **Tools**                  | Git and GitHub and GitLab, VS Code and Claude code|

---

## My Certifications
*(All certifications can be verified via this link below.)*

*[See certifications](https://github.com/AlexandreCoussediere/Certification)*
...
## **Interests**
- **Computing**: Programming, web development, video games, cybersecurity.
- **Languages**: English and Spanish (learned at school), Portuguese (self-taught).
- **Other**: Ecology, sports, chess.

---
## **About Me**
Passionate about technology and languages, I am **self-taught, meticulous, and always eager to learn**. I am capable of **independent learning** (certifications, projects) and **teamwork** (academic or personal collaborations). My goal? To **contribute to innovative projects** while developing both my technical and interpersonal skills.

---
***Note**: This repository is constantly evolving! I regularly work on new projects.*
